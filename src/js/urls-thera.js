  ...
  cities.forEach((city) => {
    ...
    camps.forEach((campaignName) => {
      ...
      let text = document.createTextNode(
        `https://megacable-promociones.com.mx/mega-movil/?campaign=${campaignName}&city=${city}&ag=th&page=entry`
      )
      link.appendChild(text)
      link.href = `https://megacable-promociones.com.mx/mega-movil/?campaign=${campaignName}&city=${city}&ag=th&page=entry`
      link.target = "_blank"
